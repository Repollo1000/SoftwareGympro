...
export class InicioSesionPage implements OnInit {
  ...
  constructor(
    ...
    private alertController: AlertController // Añade AlertController al constructor
  ) { }
      ...
      this.http.post('http://localhost:3000/auth/login', formData)
        .subscribe((response: any) => {
          ...
          if (response.rol === 'Admin') {
            this.router.navigate(['/subir-servicios']); // Redirige a página especial para admin
          } else {
